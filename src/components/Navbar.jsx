...
const HIRE_ME_MESSAGE = "Hello Amith, I came across your DevOps portfolio and would like to connect regarding a Cloud / Infrastructure Engineering opportunity.";
...
const Navbar = () => {
  ...
  return (
    <>
        ...
        >
          ...
          >
            ...
            <p className="text-slate-600 text-sm mb-4 font-medium">
              Copy the inquiry message below to send directly to Amith Raj:
            </p>
            ...
            <div className="flex gap-3">
              <a
                ...
                onClick={() => setFallbackVisible(false)}
                className="flex-1 text-center px-5 py-3 rounded-full glass-dark-btn text-xs font-bold"
              >
                Open LinkedIn
              </a>
              <button
      ...
      {/* Main Floating Navbar — Shifted to top edge (`top-1 md:top-1.5`) */}
      <nav
      ...
      >
        <div className="max-w-6xl mx-auto glass-panel px-6 py-2 rounded-full flex justify-between items-center transition-all duration-300">
          ...
          <a href="#" className="text-slate-900 font-extrabold text-base md:text-lg tracking-tight flex items-center gap-1">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button
              ...
              className="px-4 py-1.5 text-xs font-bold glass-dark-btn cursor-pointer"
            >
              Hire Me
            </button>
          </div>
          ...
          <div className="md:hidden mt-2 max-w-6xl mx-auto glass-panel p-5 rounded-3xl flex flex-col space-y-2.5 shadow-xl">
            {navLinks.map((link) => (
              <a
                ...
                className="text-slate-800 hover:text-black font-semibold text-xs py-1.5 border-b border-slate-200/50"
              >
                {link}
              </a>
            ))}
            <div className="pt-2">
              <button
                ...
                className="w-full py-2.5 glass-dark-btn text-xs font-bold text-center"
              >
                Hire Me
              </button>
            </div>
